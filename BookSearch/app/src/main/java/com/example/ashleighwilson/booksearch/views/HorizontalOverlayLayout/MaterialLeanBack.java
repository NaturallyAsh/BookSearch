...
import com.example.ashleighwilson.booksearch.views.HorizontalOverlayLayout.line.LineViewHolder;
...
public class MaterialLeanBack extends FrameLayout {
    ...
    public void setAdapter(Adapter adapter) {
        ...
        //lineAdapter = new LineAdapter(settings, adapter, customizer, onItemClickListenerWrapper);
    ...
    public void notifyCellDataChanged() {
