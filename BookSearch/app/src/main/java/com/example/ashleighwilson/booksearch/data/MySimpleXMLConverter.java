...
public class MySimpleXMLConverter implements Converter {
    private static final String TAG = MySimpleXMLConverter.class.getSimpleName();
    ...
    public Object fromBody(TypedInput body, Type type) throws ConversionException {
        try {
            ...
            return serializer.read((Class<?>) type, inputStream, false);
        } catch (Exception e) {
    ...
    public Object fromString(String string, Type type) throws ConversionException {
        try {
            return serializer.read((Class<?>) type, string, false);
        } catch (Exception e) {
            throw new ConversionException(e);
        }
    }
